...
import { LoginRequestSchema, SignupRequestSchema } from '../validation/zod/schema.js';
...
router.post('/signin', requestValidationHandler({ bodySchema: LoginRequestSchema }), asyncHandler(authController.signin));
